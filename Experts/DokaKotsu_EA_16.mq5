...
input string InpIndicatorName = "DokaKotsu_indicator_16"; // 読み込むインジ名 ★2026-07-21: 15→16(VolScore最終ゲート追加に伴う参照先更新)
