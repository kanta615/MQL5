...
//|                                                                  |
//|  ■ このEAは何をするか(役割)                                     |
//|    DokaKotsu_indicator_9 が出すシグナルを「来たら速攻で実行」    |
...
//=== 入力 =========================================================
input string InpVersionInfo  = "v9.0 / EA_9 / 連敗ロット + 金曜停止 + イベント/米国休日/年末年始 + 停止理由GV + Discord"; // ★バージョン(確認用)
...
input string InpIndicatorName = "DokaKotsu_indicator_9"; // 読み込むインジ名
...
//+------------------------------------------------------------------+
//| 理由コード → 日本語(インジ DokaKotsu_indicator_9 と対応)        |
//+------------------------------------------------------------------+
