...
input string InpIndicatorName = "DokaKotsu_indicator_14"; // 読み込むインジ名
...
//+------------------------------------------------------------------+
enum EV_KIND { EV_NONE=0, EV_CPI=1, EV_NFP=2, EV_ISM=3, EV_FOMC=4, EV_PPI=5 };   // ★2026-07-15: EV_PPI追加(CPIと同じ扱い)
...
//|  6=米国休日 7=日本休日(年末年始) 8=連敗 9=週末クローズ 10=日次損失 11=ISM(2026-07-06追加) 12=PPI(2026-07-15追加) 13=ダッシュボード手動停止(2026-07-15追加) |
//+------------------------------------------------------------------+
...
void OnTick()
{
   ...
   if(curBar != g_lastBarTime)
   {
      ...
      bool lossStop = DK_IsLossStopped();
      bool dayStop  = DK_IsDayPipStopped();
      string evName = (g_evKind==EV_FOMC)?"FOMC発表前停止":(g_evKind==EV_NFP)?"雇用統計発表前停止":(g_evKind==EV_ISM)?"ISM発表前停止":(g_evKind==EV_PPI)?"PPI発表前停止":"CPI発表前停止";
