...
//|                                                                  |
//|  ■ このEAは何をするか(役割)                                     |
//|    DokaKotsu_indicator_5 が出すシグナルを「来たら速攻で実行」    |
...
//=== バージョン(最新確認用) =======================================
#define EA_VERSION "v2.3"
#define EA_BUILD   "2026-06-10 EA_2 / 段階建値ラダー+イベント予防線"

//=== 入力 =========================================================
input string InpVersionInfo  = "v2.3 / EA_2 / 段階建値+イベント予防線+金曜停止(JST土02:00)"; // ★バージョン(確認用)
...
input string InpIndicatorName = "DokaKotsu_indicator_5"; // 読み込むインジ名
...
//+------------------------------------------------------------------+
//| 理由コード → 日本語(インジ DokaKotsu_indicator_2 と対応)        |
//+------------------------------------------------------------------+
