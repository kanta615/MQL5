...
//|                                                                  |
//|  ■ このEAは何をするか(役割)                                     |
//|    DokaKotsu_indicator_11 が出すシグナルを「来たら速攻で実行」   |
...
//=== 入力 =========================================================
input string InpVersionInfo  = "v11.0 / EA_11 / 参照先=DokaKotsu_indicator_11 / 連敗ロット + 金曜停止 + イベント/米国休日/年末年始 + 停止理由GV + Discord / 2026-06-25 オセアニア解放07:00→08:58 / 2026-06-26 連敗カウントをポジション単位に修正(分割約定/✖再送の多重カウント解消)"; // ★バージョン(確認用)
...
input string InpIndicatorName = "DokaKotsu_indicator_11"; // 読み込むインジ名
...
int OnInit()
{
   ...
   Print("==== DokaKotsu_EA_11  build:v11.0-0706  起動(indicator_11リンク更新) ====");
...
//+------------------------------------------------------------------+
//| 理由コード → 日本語(インジ DokaKotsu_indicator_11 と対応)       |
//+------------------------------------------------------------------+
