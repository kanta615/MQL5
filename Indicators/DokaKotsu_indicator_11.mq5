//+------------------------------------------------------------------+
//|                              DokaKotsu_indicator_11.mq5            |
//|   バージョン : Ver11.0(_11)  修正日 : 2026-07-05 (ADXトレンドフィルター追加)|
//|                                                                  |
//|  ■■ 最重要・絶対ルール(EAと共通) ■■                            |
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "DokaKotsu_indicator_11"); // ファイル名と一致させ括弧表示を解消
