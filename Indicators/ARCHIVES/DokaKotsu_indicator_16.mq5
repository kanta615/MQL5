...
//|   バージョン : Ver16.00(_16)  修正日 : 2026-07-21                  |
//|                                                                  |
...
input double InpVolScoreLowPct   = 0.0;    // グレー境界(%)。DokaKotsu_Dashboard/VolScore_Subと同じ式・同じ既定値(0=ゼロライン)
