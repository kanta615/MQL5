...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
{
   int need = MathMax(MathMax(MathMax(MathMax(InpEmaPeriod, InpSmaPeriod), InpWmaPeriod), InpLongPeriod), InpAdxEmaPeriod) + 5;
   ...
   for(int j=0; j<need && j<rates_total; j++)
   {
      ...
      BufReason[j]=0.0; BufM15State[j]=0.0; BufLongState[j]=0.0; BufAdxState[j]=0.0;
   }
