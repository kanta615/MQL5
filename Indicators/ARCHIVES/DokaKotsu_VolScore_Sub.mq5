...
input double InpVolScoreLowPct  = 0.0;    // グレー境界(2026-07-21: -40→0。これ未満=グレー。ゼロライン=境界)
input double InpVolScoreMidPct  = 30.0;   // これ未満=イエロー
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_LEVELTEXT, 0, "0%(グレー境界)");
